...
import com.dev.libsillycript.core.memory.RandomAccessData
...
open class VeraCryptMaster(
    ...
    suspend fun open(
        ...
        return open(MemoryRandomAccessData(input), password, kdf, cipherTypes, isHidden)
    }
    ...
    suspend fun open(
        ...
        return open(FileRandomAccessData(input), password, kdf, cipherTypes, isHidden)
    }
    ...
    suspend fun open(
        ...
        return withContext(safeDispatcher) {
            openUnsafe(input, password, kdf, cipherTypes, isHidden)
        }
    }

    private suspend fun openUnsafe(
        input: RandomAccessData,
        password: CharArray,
        kdf: KDFType,
        cipherTypes: List<BlockCipherType>,
