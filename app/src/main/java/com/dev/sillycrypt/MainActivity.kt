...
fun Greeting(name: String, modifier: Modifier = Modifier) {
    ...
    LaunchedEffect(Unit) {
        ...
        val thirdVolume = AndroidVeracryptMaster(MutableStateFlow(100L)).open(context.filesDir.resolve("testNew"),charArrayOf('a','b','c'),
            KDFType.PBKDF2, listOf(BlockCipherType.AES))
        val data = context.filesDir.resolve("/data/data/com.osakadev.osakacrypt/files/Disk Image of mapper_veracrypt1 (2025-07-14 0110).img").readBytes()
